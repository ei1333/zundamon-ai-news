...
CHIPS = [
    ((650, 246, 838, 280, 17), (59, 130, 246, 46), '透明性', (674, 260), (220, 235, 255, 255)),
    ((852, 246, 980, 280, 17), (168, 85, 247, 46), '研究', (877, 260), (242, 222, 255, 255)),
    ((650, 294, 806, 328, 17), (47, 158, 68, 51), 'インフラ', (674, 308), (226, 255, 231, 255)),
]
BARS = [
...
def render_ogp(*, out_path: Path, text_nodes: list[tuple], multiline_blocks: list[tuple] | None = None, chips=CHIPS):
    ...
    draw_text_anchor(draw, (706, 205), 'ON AIR', load_font(16, bold=True), (255, 255, 255, 255), 'middle')
